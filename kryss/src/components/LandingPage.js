...
const landingPage = () => {
  return (
    <div>
      ...
      {/*  */}
      <div className="bg-black place-content-around h-screen flex flex-row justify-center items-center ">
        <div className="flex flex-col">
          ...
          <h5 className="lg:text-2xl md:text-xl sm:text-3sm text-1xl font-bold text-white mb-14 shadow-2xl">
            WE LOOK INTO THE FUTURE SND BUILD EVs
          </h5>
          <h5 className="lg:text-2xl md:text-xl sm:text-sm text-1xl font-bold text-white mb-14 shadow-2xl">
      ...
      <div className="bg-black h-screen flex flex-col justify-center items-center">
        ...
        <h1 className="lg:text-4xl md:text-2xl sm:text-1xl text-xl font-bold text-white mb-14 shadow-2xl mt-20">
          DEDICATION + DISCIPLINE + PLANNING + SAVE NATURE + CRAFTING + WIN
          FORMULA
        </h1>
        <h1 className="lg:text-4xl md:text-2xl sm:text-1xl text-xl font-bold text-white mb-14 shadow-2xl">
          COMING SOON
        </h1>
      </div>
      {/*  */}
      ...
      <div className="bg-black flex justify-center h-screen items-center">
        <h1 className="lg:text-6xl md:text-4xl sm:text-3xl text-1xl font-bold text-white  shadow-2xl">
